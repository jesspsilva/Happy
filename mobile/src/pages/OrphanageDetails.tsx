...
import LoadingAnimation from './LoadingEffect';
...
export default function OrphanageDetails() {
    ...
    function openWhatsApp(whatsAppNumber: Number){
        let url = `whatsapp://send?phone=${whatsAppNumber}`;
    ...
    <ScrollView style={styles.container}>
        ...
        <View style={styles.detailsContainer}>
            ...
            {orphanage.whatsapp_number != null && (
                <RectButton style={styles.contactButton} onPress={() => openWhatsApp(orphanage.whatsapp_number)}>
